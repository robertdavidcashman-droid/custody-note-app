...
meta_title: Chatham Police Station Representative — Cover & Advice
meta_description: Police station representation in Chatham for criminal defence firms. Accredited cover, DSCC attendances, and structured attendance notes. General information — not case-specific advice.
h1: Chatham Police Station Representative
...
Criminal defence firms instructing police station cover in **Chatham** need prompt attendance, accredited representation where required, and clear attendance notes for billing and handover. Robert Cashman / Defence Legal Services provides agency cover across Kent and Medway including Medway towns including Chatham.

## Local context

Chatham falls within Kent Police force area. Custody suites vary in size and disclosure practice. Instructing solicitors should provide DSCC references, client details, offence summary, and conflict information as early as possible.
...
### Do you cover Chatham overnight?
