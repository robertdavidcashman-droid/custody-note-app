...
meta_title: Sevenoaks Police Station Representative — Cover & Advice
meta_description: Police station representation in Sevenoaks for criminal defence firms. Accredited cover, DSCC attendances, and structured attendance notes. General information — not case-specific advice.
h1: Sevenoaks Police Station Representative
...
Criminal defence firms instructing police station cover in **Sevenoaks** need prompt attendance, accredited representation where required, and clear attendance notes for billing and handover. Robert Cashman / Defence Legal Services provides agency cover across Kent and Medway including Sevenoaks and nearby stations.

## Local context

Sevenoaks falls within Kent Police force area. Custody suites vary in size and disclosure practice. Instructing solicitors should provide DSCC references, client details, offence summary, and conflict information as early as possible.
...
### Do you cover Sevenoaks overnight?
