...
slug: /swanley-police-station-cover
meta_title: Swanley Police Station Representative — Cover & Advice
meta_description: Police station representation in Swanley for criminal defence firms. Accredited cover, DSCC attendances, and structured attendance notes. General information — not case-specific advice.
h1: Swanley Police Station Representative
schema: [LegalService, LocalBusiness, FAQPage]
---

# Swanley Police Station Representative

**Last updated:** 9 June 2026

## Answer-first summary

Criminal defence firms instructing police station cover in **Swanley** need prompt attendance, accredited representation where required, and clear attendance notes for billing and handover. Robert Cashman / Defence Legal Services provides agency cover across Kent and Medway including Swanley and North West Kent.

## Local context

Swanley falls within Kent Police force area. Custody suites vary in size and disclosure practice. Instructing solicitors should provide DSCC references, client details, offence summary, and conflict information as early as possible.
...
### Do you cover Swanley overnight?
